Feature: editing user profile
  ...
  So that I can modify my username, email or password
...
Scenario: successfully modifies name, email, and password
  ...
  Then I should see the following: Profile updated, User2, user2@gmail.com
  When I follow "Log out"
  When I follow "Log in"
  When I fill in the login information: user@gmail.com, 12345678
  Then I press "Log in"
  Then I should see "Invalid email/password combination"
  When I fill in the login information: user2@gmail.com, 555555
  Then I press "Log in"
  Then I should see the following: We know health insurance can be confusing, Estimate Cost, Find Doctors

Scenario: editing an account with nothing filled
  When I fill in the following information: , , , 
  When I press "Save changes"
  Then I should see the following: The form contains 5 errors, Name can't be blank, Email can't be blank Email is invalid, Password confirmation doesn't match Password, Password is too short (minimum is 6 characters)

Scenario: editing an account with where the username is more than 50 characters
  When I fill in the following information: thisisoverfiftycharactersthisisoverfiftycharactersthisisoverfiftycharacters, user@gmail.com
  When I press "Save changes"
  Then I should see the following: The form contains 1 error, Name is too long (maximum is 50 characters)

Scenario: editing an account with incorrect email regex
  When I fill in the following information: User2, usergmail.com
  When I press "Save changes"
  Then I should see the following: The form contains 1 error, Email is invalid

Scenario: editing an account with an email that already exists
  When I follow "Log out"
  When I follow "Login"
  When I follow "Sign up now!"
  Then I should see "Sign Up"
  ...
  When I press "Create my account"
  When I follow "Settings"
  When I fill in the following information: User2, user@gmail.com, 12345678, 12345678
  When I press "Save changes"
  Then I should see the following: The form contains 1 error, Email has already been taken

Scenario: editing an account with where the password is less than 6 characters
...
Scenario: editing an account with incorrect confirmation
